...
int main(int argc, char **argv)
{
    ...
    if(argc < 4)
    {
        cerr << endl << "Client Usage: ./stereo_euroc VOC_PATH SETTINGS_PATH RUN_TYPE(client|server) LEFT_PATH RIGHT_PATH TIMES_PATH" << endl;
        cerr << endl << "Server Usage: ./stereo_euroc VOC_PATH SETTINGS_PATH RUN_TYPE(client|server)" << endl;
        return 1;
    }
