...
int main(int argc, char **argv)
{
    ...
    if(argc < 4)
    {
        cerr << endl << "Client Usage: ./mono_kitti VOC_PATH SETTINGS_PATH RUN_TYPE(client|server) SEQUENCE_PATH" << endl;
        cerr << endl << "Server Usage: ./mono_kitti VOC_PATH SETTINGS_PATH RUN_TYPE(client|server)" << endl;
        return 1;
    }
